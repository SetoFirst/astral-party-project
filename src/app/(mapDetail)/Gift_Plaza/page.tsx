...
import { ListGift_Plaza } from "@/app/store/ListPlatform";

export const runtime = "edge";

export default function Gift_Plaza() {
  const router = useRouter();
  const BackClick = () => router.push("/map");

  // State สำหรับเก็บข้อมูลแพลตฟอร์ม
  const [platforms, setPlatforms] = useState(ListGift_Plaza);
  ...
  return (
    <div className="bg-gradient-to-tr from-[#be185d]/50 via-[#f472b6]/50 to-[#fbcfe8]/50 mx-4 mt-4 min-h-screen flex flex-col items-center">
      ...
      <div className="text-center bg-gray-700 w-full max-w-4xl p-8 rounded-lg shadow-lg">
        {/* Title */}
        <div className="pb-10">
          <p className="text-4xl text-white">Gift Plaza</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          {/* Image */}
          <img
            src="https://static.wikitide.net/astralpartywiki/thumb/4/4d/Layout_Gift_Plaza.png/500px-Layout_Gift_Plaza.png"
            alt="Gift Plaza Layout"
