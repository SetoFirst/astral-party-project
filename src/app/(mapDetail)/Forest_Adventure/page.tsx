...
export default function ListForest_Adventure() {
  ...
  const platforms =
    activeTab === "up" ? ListForest_AdventureUp : ListForest_AdventureDown;

  // เลือกรูปภาพตาม tab
  const imageSrc =
    activeTab === "up"
      ? "https://static.wikitide.net/astralpartywiki/thumb/9/9a/Layout_Forest_Adventure.png/500px-Layout_Forest_Adventure.png"
      : "https://static.wikitide.net/astralpartywiki/thumb/3/33/Layout_Forest_Adventure_2.png/500px-Layout_Forest_Adventure_2.png";
  ...
  return (
    <div className="bg-gradient-to-tr from-[#be185d]/50 via-[#f472b6]/50 to-[#fbcfe8]/50 mx-4 mt-4 min-h-screen flex flex-col items-center">
      ...
      <div className="text-center bg-gray-700 w-full max-w-4xl p-8 rounded-lg shadow-lg">
        {/* Title */}
        <div className="pb-10">
          <p className="text-4xl text-white">Forest Adventure</p>
        </div>
