...
const IMAGES = {
  Main: `${discription[16].imageCharacter}`,
  attackIcon:
...
const Expression = discription[16].expressions;
    ...
    <div className="bg-gradient-to-tr from-[#be185d]/50 via-[#f472b6]/50 to-[#fbcfe8]/50 mx-4 mt-4">
        ...
        <div className="p-10">
          <div className="flex justify-around h-[40px] bg-gray-500">
            <Stat
              ...
              value={discription[16].statCharacter?.attackValue}
              emojicon={undefined}
            />
            <Stat
              icon={IMAGES.defenseIcon}
              value={discription[16].statCharacter?.defenseValue}
              emojicon={undefined}
            />
            <Stat
              icon={IMAGES.hpIcon}
              value={discription[16].statCharacter?.hpValue}
              emojicon={undefined}
            />
          </div>
          ...
          <span className="text-xl">
            <b>Name:</b> {discription[16].profile?.Name} <br />
            <b>Birthday:</b> {discription[16].profile?.Birthday} <br />
            <b>Favorite Food:</b> {discription[16].profile?.FavoriteFood} <br />
            {discription[16].profile?.discriptions}
          </span>
          <br />
          <br />
          <span className="text-4xl">
            <div className="flex">
              ...
              <Stat
                ...
                value={discription[16].statCharacter?.timeValue}
                emojicon={undefined}
              />
            </div>
          </span>
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[16].activeSkill}</span>
          <br />
          <br />
          <span className="text-4xl">
            <b>Passive Skil</b>{" "}
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[16].passiveSkill}</span>
        </div>
      </div>
      <div className="text-4xl pl-20 pr-10 md:pl-10">
        ...
        <div className="flex flex-wrap gap-[20px] pb-10">
          ...
          <ExStat emojicon={Expression?.emoji_13} icon={""} value={undefined} />
        </div>
      </div>
    </div>
  );
