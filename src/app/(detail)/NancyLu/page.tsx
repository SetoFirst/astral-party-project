...
const IMAGES = {
  Main: `${discription[17].imageCharacter}`,
  attackIcon:
...
const Expression = discription[17].expressions;
        ...
        <div className="p-10">
          <div className="flex justify-around h-[40px] bg-gray-500">
            <Stat
              ...
              value={discription[17].statCharacter?.attackValue}
              emojicon={undefined}
            />
            <Stat
              icon={IMAGES.defenseIcon}
              value={discription[17].statCharacter?.defenseValue}
              emojicon={undefined}
            />
            <Stat
              icon={IMAGES.hpIcon}
              value={discription[17].statCharacter?.hpValue}
              emojicon={undefined}
            />
          </div>
          ...
          <span className="text-xl">
            <b>Name:</b> {discription[17].profile?.Name} <br />
            <b>Birthday:</b> {discription[17].profile?.Birthday} <br />
            <b>Favorite Food:</b> {discription[17].profile?.FavoriteFood} <br />
            {discription[17].profile?.discriptions}
          </span>
          <br />
          <br />
          <span className="text-4xl">
            <div className="flex">
              ...
              <Stat
                ...
                value={discription[17].statCharacter?.timeValue}
                emojicon={undefined}
              />
            </div>
          </span>
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[17].activeSkill}</span>
          <br />
          <br />
          <span className="text-4xl">
            <b>Passive Skil</b>{" "}
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[17].passiveSkill}</span>
        </div>
      </div>
