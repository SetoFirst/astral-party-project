...
const IMAGES = {
  Main: `${discription[21].imageCharacter}`,
  attackIcon:
...
const Expression = discription[21].expressions;
        ...
        <div className="p-10">
          <div className="flex justify-around h-[40px] bg-gray-500">
            <Stat
              ...
              value={discription[21].statCharacter?.attackValue}
              emojicon={undefined}
            />
            <Stat
              icon={IMAGES.defenseIcon}
              value={discription[21].statCharacter?.defenseValue}
              emojicon={undefined}
            />
            <Stat
              icon={IMAGES.hpIcon}
              value={discription[21].statCharacter?.hpValue}
              emojicon={undefined}
            />
          </div>
          ...
          <span className="text-xl">
            <b>Name:</b> {discription[21].profile?.Name} <br />
            <b>Birthday:</b> {discription[21].profile?.Birthday} <br />
            <b>Favorite Food:</b> {discription[21].profile?.FavoriteFood} <br />
            {discription[21].profile?.discriptions}
          </span>
          <br />
          <br />
          <span className="text-4xl">
            <div className="flex">
              ...
              <Stat
                ...
                value={discription[21].statCharacter?.timeValue}
                emojicon={undefined}
              />
            </div>
          </span>
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[21].activeSkill}</span>
          <br />
          <br />
          <span className="text-4xl">
            <b>Passive Skil</b>{" "}
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[21].passiveSkill}</span>
        </div>
      </div>
