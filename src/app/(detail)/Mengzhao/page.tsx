...
const IMAGES = {
  Main: `${discription[19].imageCharacter}`,
  attackIcon:
...
const Expression = discription[19].expressions;
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center pl-10 pt-10">
        ...
        <div className="p-10">
          ...
          <span className="text-xl">
            <b>Name:</b> {discription[19].profile?.Name} <br />
            <b>Birthday:</b> {discription[19].profile?.Birthday} <br />
            <b>Favorite Food:</b> {discription[19].profile?.FavoriteFood} <br />
            {discription[19].profile?.discriptions}
          </span>
          <br />
          <br />
          <span className="text-4xl">
            <div className="flex">
              ...
              <Stat
                ...
                value={discription[19].statCharacter?.timeValue}
                emojicon={undefined}
              />
            </div>
          </span>
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[19].activeSkill}</span>
          <br />
          <br />
          <span className="text-4xl">
            <b>Passive Skil</b>{" "}
          ...
          <hr />
          <br />
          <span className="text-xl">{discription[19].passiveSkill}</span>
        </div>
      </div>
